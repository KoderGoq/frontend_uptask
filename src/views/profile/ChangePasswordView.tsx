...
import type { updateCurrentPassowrdForm } from '@/types';
import { useMutation } from '@tanstack/react-query';
import { changePassword } from '@/api/ProfileApi';
import { toast } from 'react-toastify';

export default function ChangePasswordView() {
  const initialValues: updateCurrentPassowrdForm = {
    current_password: '',
    password: '',
  ...
  const handleChangePassword = (formData: updateCurrentPassowrdForm) => mutate(formData);
